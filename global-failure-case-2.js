async function globalFailure2(){
    ...
    try{
        ...
        await fetch("http://localhost:8080/closenode/:1")
        ...
        await fetch("http://localhost:8080/opennode/:1")
        console.log("connection to Node1 restored");
