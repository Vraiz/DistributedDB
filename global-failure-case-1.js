async function globalFailure1(){
    ...
    try{
        ...
        await fetch("http://localhost:8080/closenode/:0")
        ...
        await fetch("http://localhost:8080/opennode/:0")
        console.log("connection to Node0 restored");
